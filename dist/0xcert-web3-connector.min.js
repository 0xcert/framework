...
window.$0xcert.web3 = __webpack_require__(176);
...
const web3_error_parser_1 = __webpack_require__(181);
...
class Context {
    ...
    getSignMethod(signMethod) {
        ...
        if ([0, 1, 2].indexOf(signMethod) === -1) {
            throw new scaffold_1.GenericProviderError(scaffold_1.GenericProviderIssue.SIGNATURE_UNKNOWN, `Unknown signature method ${signMethod}`);
        }
        return signMethod;
    }
    signData(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                throw new scaffold_1.GenericProviderError(scaffold_1.GenericProviderIssue.SIGNATURE_FAILED, error);
            }
        });
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
var GenericProviderIssue;
(function (GenericProviderIssue) {
    GenericProviderIssue[GenericProviderIssue["UNHANDLED"] = 0] = "UNHANDLED";
    GenericProviderIssue[GenericProviderIssue["GENERAL_REVERT"] = 1] = "GENERAL_REVERT";
    GenericProviderIssue[GenericProviderIssue["SIGNATURE_UNKNOWN"] = 9000] = "SIGNATURE_UNKNOWN";
    GenericProviderIssue[GenericProviderIssue["SIGNATURE_FAILED"] = 9001] = "SIGNATURE_FAILED";
    GenericProviderIssue[GenericProviderIssue["ZERO_ADDRESS"] = 1001] = "ZERO_ADDRESS";
    GenericProviderIssue[GenericProviderIssue["INVALID_NFT"] = 1002] = "INVALID_NFT";
    GenericProviderIssue[GenericProviderIssue["NOT_AUTHORIZED"] = 1003] = "NOT_AUTHORIZED";
    GenericProviderIssue[GenericProviderIssue["RECEIVER_DOES_NOT_SUPPORT_NFT"] = 1004] = "RECEIVER_DOES_NOT_SUPPORT_NFT";
    GenericProviderIssue[GenericProviderIssue["NFT_ALREADY_EXISTS"] = 1005] = "NFT_ALREADY_EXISTS";
    GenericProviderIssue[GenericProviderIssue["INVALID_INDEX"] = 1006] = "INVALID_INDEX";
    GenericProviderIssue[GenericProviderIssue["TRANSFERS_PAUSED"] = 1007] = "TRANSFERS_PAUSED";
    GenericProviderIssue[GenericProviderIssue["COIN_TRANSFER_FAILED"] = 1008] = "COIN_TRANSFER_FAILED";
    GenericProviderIssue[GenericProviderIssue["INVALID_SIGNATURE_KIND"] = 1009] = "INVALID_SIGNATURE_KIND";
    GenericProviderIssue[GenericProviderIssue["INVALID_PROXY"] = 1010] = "INVALID_PROXY";
    GenericProviderIssue[GenericProviderIssue["YOU_ARE_NOT_THE_TAKER"] = 1011] = "YOU_ARE_NOT_THE_TAKER";
    GenericProviderIssue[GenericProviderIssue["SENDER_NOT_TAKER_OR_MAKER"] = 1012] = "SENDER_NOT_TAKER_OR_MAKER";
    GenericProviderIssue[GenericProviderIssue["ORDER_EXPIRED"] = 1013] = "ORDER_EXPIRED";
    GenericProviderIssue[GenericProviderIssue["INVALID_SIGNATURE"] = 1014] = "INVALID_SIGNATURE";
    GenericProviderIssue[GenericProviderIssue["ORDER_CANCELED"] = 1015] = "ORDER_CANCELED";
    GenericProviderIssue[GenericProviderIssue["ORDER_CANNOT_BE_PERFORMED_TWICE"] = 1016] = "ORDER_CANNOT_BE_PERFORMED_TWICE";
    GenericProviderIssue[GenericProviderIssue["YOU_ARE_NOT_THE_MAKER"] = 1017] = "YOU_ARE_NOT_THE_MAKER";
    GenericProviderIssue[GenericProviderIssue["SIGNER_NOT_AUTHORIZED"] = 1018] = "SIGNER_NOT_AUTHORIZED";
    GenericProviderIssue[GenericProviderIssue["ONE_ZERO_ABILITY_HAS_TO_EXIST"] = 1019] = "ONE_ZERO_ABILITY_HAS_TO_EXIST";
    GenericProviderIssue[GenericProviderIssue["TRANSATION_RESPONSE_ERROR_CHECK_PENDING_TRANSACTIONS"] = 2001] = "TRANSATION_RESPONSE_ERROR_CHECK_PENDING_TRANSACTIONS";
    GenericProviderIssue[GenericProviderIssue["INVALID_ADDRESS"] = 2002] = "INVALID_ADDRESS";
})(GenericProviderIssue = exports.GenericProviderIssue || (exports.GenericProviderIssue = {}));
class GenericProviderError extends Error {
...
exports.GenericProviderError = GenericProviderError;
...
exports.GenericProviderError = scaffold_1.GenericProviderError;
exports.GenericProviderIssue = scaffold_1.GenericProviderIssue;
...
const web3_asset_ledger_1 = __webpack_require__(184);
const web3_value_ledger_1 = __webpack_require__(195);
const web3_order_exchange_1 = __webpack_require__(200);
class GenericProvider {
    ...
    getOrderGateway(id = null) {
        return __awaiter(this, void 0, void 0, function* () {
            return new web3_order_exchange_1.OrderGateway(this.context, id);
        });
    }
    createQueue(schema) {
        return null;
...
Object.defineProperty(exports, "__esModule", { value: true });
const get_abilities_1 = __webpack_require__(186);
const get_capabilities_1 = __webpack_require__(187);
const get_info_1 = __webpack_require__(188);
const get_supply_1 = __webpack_require__(189);
const get_transfer_state_1 = __webpack_require__(190);
const assign_abilities_1 = __webpack_require__(191);
const revoke_abilities_1 = __webpack_require__(192);
const set_transfer_state_1 = __webpack_require__(193);
const env = __webpack_require__(194);
class AssetLedger {
...
Object.defineProperty(exports, "__esModule", { value: true });
const get_info_1 = __webpack_require__(197);
const get_supply_1 = __webpack_require__(198);
const env = __webpack_require__(199);
class ValueLedger {
    constructor(context, id) {
        this.context = context;
        this.contract = this.getContract(id);
...
Object.defineProperty(exports, "__esModule", { value: true });
const scaffold_1 = __webpack_require__(8);
const web3_utils_1 = __webpack_require__(202);
const env = __webpack_require__(208);
class OrderGateway {
    constructor(context, id) {
        this.context = context;
        this.contract = this.getContract(id);
    ...
    createOrderHash(order) {
        ...
        return this.context.web3.utils.soliditySha3(this.id, web3_utils_1.toString(order.makerId), web3_utils_1.toString(order.takerId), temp, web3_utils_1.toInteger(order.seed), web3_utils_1.toSeconds(order.expiration));
    }
    getHashKind(action) {
