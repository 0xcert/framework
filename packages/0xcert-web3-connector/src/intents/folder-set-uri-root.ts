import { FolderSetUriRootRecipe, FolderSetUriRootResult, FolderSetUriRootMutation } from '@0xcert/connector';
 ...
 * Mutation class for.
 */
export class FolderSetUriRootIntent extends Web3Mutation implements FolderSetUriRootMutation {
  protected recipe: FolderSetUriRootRecipe;
   ...
   */
  public constructor(connector: Connector, recipe: FolderSetUriRootRecipe) {
    super(connector);
    this.recipe = recipe;
  }
