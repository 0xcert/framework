import { IFolderCheckIsPausedConnectorRequest as IConnectorRequest,
  IFolderCheckIsPausedConnectorResponse as IConnectorResponse } from '@0xcert/connector';
import { Connector } from '../core/connector';
import * as env from '../config/env';

/**
 * Connector request resolver for ConnectorAction.FOLDER_CHECK_IS_PAUSED.
