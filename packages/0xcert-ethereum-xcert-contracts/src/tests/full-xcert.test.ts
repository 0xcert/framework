...
spec.beforeEach(async (ctx) => {
  const xcert = await ctx.deploy({
    ...
    contract: 'XcertMock',
    args: ['Foo', 'F', 'https://0xcert.org/', '.json', '0x9c22ff5f21f0b81b113e63f7db6da94fedef11b2119b4088b89664fb9a3cb658', ['0x9d118770', '0xbda0e852', '0xbedb86fb', '0x20c5429b']],
  });
  ctx.set('xcert', xcert);
});
...
spec.test('supports interfaces', async (ctx) => {
  ...
  ctx.true(await xcert.instance.methods.supportsInterface('0xbda0e852')); // mutable
