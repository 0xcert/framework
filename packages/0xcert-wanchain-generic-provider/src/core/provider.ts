...
export class GenericProvider extends EthereumGenericProvider {
  ...
  public constructor(options: GenericProviderOptions) {
    super({
      ...
      assetLedgerSource: options.assetLedgerSource || 'https://0xcert.org/conventions/wanchain/xcert-mock.json',
      valueLedgerSource: options.valueLedgerSource || 'https://0xcert.org/conventions/wanchain/token-mock.json',
      ...options,
    });
  }
}
