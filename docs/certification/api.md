...
* Each object is flattened into an array of values based on alphabetically ordered property names.
...
* Schema object properties are sorted in alphapetic order.
